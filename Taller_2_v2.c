...
{ 
   ...
   do{
    ...
    printf("El valor total seria de: $%.1f, ¿Desea llevar algo mas?\n", total_por_kilos_frutas(kilos_fruta,valor_fruta));

    resultado_fruta = total_por_kilos_frutas(kilos_fruta, valor_fruta) + resultado_fruta;
}   
  ...
  scanf("%i", &opt1_verduras);
    ...
    printf("El valor total seria de: $%.1f, ¿Desea llevar algo mas?\n",total_por_kilos_verduras(kilos_verdura,valor_verduras));

    resultado_verdura = total_por_kilos_verduras(kilos_verdura, valor_verduras) + resultado_verdura;
...
//fin de programa
  ...
  printf("El total es: $%.1f", resultado_fruta+resultado_verdura);
